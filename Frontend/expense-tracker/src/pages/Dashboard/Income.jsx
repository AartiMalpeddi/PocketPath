...
const Income = () => {
  ...
  const fetchIncomeDetails=async()=>{
    ...
    setLoading(true)
    try { 
      const resp=await axiosInstance.get(`${API_PATHS.INCOME.GET_ALL_INCOME}`)
      if(resp.data) setIncomeData(resp.data)
    } catch (error) {
  ...
  return (
    <DashboardLayout activeMenu="Income">
      <div className='my-5 mx-auto'>
        ...
        <Modal isOpen={openAddIncomeModel} onClose={()=>setOpenAddIncomeModel(false)}
        title="Add Income">
